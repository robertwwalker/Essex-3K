...
## F-statistic:  69.5 on 3 and 44 DF,  p-value: < 2.2e-16
```
...
## 
## sigma^2 estimated as 7.982:  log likelihood = -118.44,  aic = 244.89
```
...
## 
## sigma^2 estimated as 6.378:  log likelihood = -113.19,  aic = 234.38
```
